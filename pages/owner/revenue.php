    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
            ...
            <main id="dashboardScroll"
                ...
                <!-- HEADER -->
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm px-6 py-5">

                    <!-- LEFT -->
                    <div class="flex items-center gap-4">

                        <!-- PAGE ICON -->
                        <div class="w-11 h-11 flex items-center justify-center rounded-lg bg-green-100 dark:bg-green-500/20">

                            <i class="fa-solid fa-money-bill-trend-up text-green-600 dark:text-green-400"></i>
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                <?= $t['revenue_analytics_overview'] ?? 'Revenue analytics overview' ?>
                            </p>
